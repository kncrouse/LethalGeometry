...
to add-group
  create-groups 1 [
    ...
    hatch-animals animals-per-group [
      ...
      set hidden? false
      set aggression-allele-1 0.5
      set aggression-allele-2 0.5
      set aggression (aggression-allele-1 + aggression-allele-2) / 2
      set velocity-allele-1 1
      set velocity-allele-2 1
...
to mutate-alleles
  if random-float 1.0 < mutation-rate [
    ...
    set velocity-allele-1 random visible-range
    set velocity-allele-2 random visible-range
  ]
end
